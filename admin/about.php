                ...
                <div class="col-lg-8">
                    <div class="about_us_content">
                        ...
                        <div class="about_us_video">
                            <img src="<?php echo $style_path; ?>img/about_us_video.png" alt="#" class="img-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="<?php echo $style_path; ?>img/icon/feature_icon_1.svg" alt="#">
                        <h4>Credit Card Support</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="<?php echo $style_path; ?>img/icon/feature_icon_2.svg" alt="#">
                        <h4>Online Order</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="<?php echo $style_path; ?>img/icon/feature_icon_3.svg" alt="#">
                        <h4>Free Delivery</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="<?php echo $style_path; ?>img/icon/feature_icon_4.svg" alt="#">
                ...
                <div class="col-lg-8">
                    <div class="subscribe_part_content">
                        ...
                        <div class="subscribe_form">
                            <input type="email" name="mail" placeholder="Enter your mail" required autocomplete="off">
